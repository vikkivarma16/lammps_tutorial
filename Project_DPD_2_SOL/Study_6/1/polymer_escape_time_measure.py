...
def count_escaped_particles(time_data, dx):
    escape_x_min, escape_x_max = -15, -10  # Escape region on the left
    escape_x_min_2, escape_x_max_2 = 10, 15  # Escape region on the right
    trapped_x_min, trapped_x_max = -10, 10  # Trapped region
...
if __name__ == '__main__':
    ...
    bin_division = 0.05
    xmin, xmax = -15, 15  # Define simulation box
