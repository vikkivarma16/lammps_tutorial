        ...
        if (box_type==1)
        {
                        ...
                        while (iter < max_iterations && error > tolerance) 
                        {
                                    ...
                                    for (j=0; j <N_z; j++)
                                    {
                                          ...
                                          d_phi[3][j][0]= d_phi[4][j][0]+(1.0/(12.0*piee))*(total_n_alpha[2][0]*total_n_alpha[2][0]*total_n_alpha[2][0]-3.0*total_n_alpha[5][0]*total_n_alpha[5][0])/ ((1.0-total_n_alpha[3][0])*(1.0-total_n_alpha[3][0])*(1.0-total_n_alpha[3][0]));
