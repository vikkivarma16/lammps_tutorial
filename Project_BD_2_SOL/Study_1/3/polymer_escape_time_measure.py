...
def count_escaped_particles(time_data, dx):
    escape_x_min, escape_x_max = 21, 36  # Escape region on the left
    escape_x_min_2, escape_x_max_2 = 21, 36  # Escape region on the right
    trapped_x_min, trapped_x_max = 0, 21  # Trapped region
...
if __name__ == '__main__':
    ...
    bin_division = 0.05
    xmin, xmax = 0, 36  # Define simulation box
