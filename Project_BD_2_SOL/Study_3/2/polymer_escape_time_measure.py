...
def count_escaped_particles(time_data, dx):
    escape_x_min, escape_x_max = 11, 24.8  # Escape region on the left
    escape_x_min_2, escape_x_max_2 = 11, 24.8  # Escape region on the right
...
if __name__ == '__main__':
    ...
    bin_division = 0.05
    xmin, xmax = 0, 24.8  # Define simulation box
